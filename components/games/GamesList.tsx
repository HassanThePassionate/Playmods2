import { Star, StarIcon } from "lucide-react"; // Remove this if not needed
    ...
    <div className="grid grid-cols-3 gap-2">
      {data.map((elem) => (
        <Link
          href="#"
          key={elem.img}
          className="flex gap-2 items-center transition duration-300 rounded-md hover:bg-[#f3f3f3] px-[10px] py-[10px]"
        >
          <Image
            src={elem.img}
            alt="img"
